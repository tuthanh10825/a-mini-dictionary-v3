...
BaseFrame::BaseFrame(const wxString& title)
    ...
    homePage->favorButton->Bind(wxEVT_BUTTON, [this](wxCommandEvent& event) {this->workingPage->ChangeSelection(5); });
...
void BaseFrame::LoadNavigation()
{
   ...
   */
    ...
    favoriteBtn->Bind(wxEVT_BUTTON, &BaseFrame::OnFavBtnClicked, this); 
...
void BaseFrame::OnFavBtnClicked(wxCommandEvent&)
{
